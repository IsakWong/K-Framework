...
namespace FSM
{
        ...
        IActionable<TEvent>
    {
        ...
        private List<StateBase<TStateId>> states = new();
        ...
        private Dictionary<TStateId, StateBundle> nameToStateBundle = new();
        ...
        private List<TransitionBase<TStateId>> transitionsFromAny = new();

        private Dictionary<TEvent, List<TransitionBase<TStateId>>> triggerTransitionsFromAny = new();
        ...
        public List<TransitionBase<TStateId>> TransitionsFromAny => transitionsFromAny;

        public Dictionary<TEvent, List<TransitionBase<TStateId>>> TriggerTransitionsFromAny =>
            triggerTransitionsFromAny;
        ...
        private void ChangeState(TStateId name)
        {
            ...
            for (var i = 0; i < activeTransitions.Count; i++)
            {
        ...
        public override void OnEnter()
        {
            ...
            for (var i = 0; i < transitionsFromAny.Count; i++)
            {
        ...
        private bool TryTrigger(TEvent trigger)
        {
            ...
            {
                for (var i = 0; i < triggerTransitions.Count; i++)
                {
