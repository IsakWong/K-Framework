...
public class KGameCore
{
    ...
    /// <summary>所有已注册模块的只读枚举（供编辑器调试用）。</summary>
    public IEnumerable<IModule> AllModules => _modules.Values;
...
#pragma warning restore CS0618
    ...
    private void Initialize()
    {
        ...
        EnhancedLog.Log("[KGameCore] Initializing...");
        DOTween.Init();
        ...
        EnhancedLog.Log($"[KGameCore] 服务初始化： ({ServiceLocator.Count})");
    }
